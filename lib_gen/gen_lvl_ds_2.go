...
func Gen_Lvl_Ds2(byteValues  []byte, 
    ...
    for _, k := range keys  {
        ...
        if Ds.CnCtNbDs.CnCtNb != Um_nbds.Um_nbds_key.Ds_keys[0].CnCtNb {
            continue
        }
        ...
        Um_nbds.Um_nbds_key.Ds_keys[ind].CnCtNb             = Ds.CnCtNbDs.CnCtNb            
        Um_nbds.Um_nbds_key.Ds_keys[ind].ID_Digital_Signage = Ds.CnCtNbDs.ID_Digital_Signage 
        Um_nbds.Um_nbds_key.Ds_keys[ind].ID_Owner           = Ds.CnCtNbDs.ID_Owner          


        //fmt.Println("      Ds =", Ds)
          fmt.Println("      ds Um_nbds =", Um_nbds)
